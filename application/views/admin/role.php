        ...
        <div class="container-fluid">
          ...
          <div class="row">
          	<div class="col-lg-6">
          		...
          		<?= form_error('role','<div class="alert alert-danger mb-3" role="alert">','</div>');?>
          		...
          		<table class="table table-hover">
                      ...
                      <a href="<?= base_url('admin/roleaccess/') . $r['id'];?>"
                       class="badge badge-warning">access</a>
          						<a href="<?= base_url('admin/role_ubah/') . $r['id'];?>" class="badge badge-success">edit</a>
          						<a href="<?= base_url('admin/hapus/') . $r['id'];?>" class="badge badge-danger">delete</a>
          					</td>
